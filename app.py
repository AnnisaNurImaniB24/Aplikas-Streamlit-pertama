...
# =========================
data = {
    'Nama': ['Nuri', 'Nisya', 'Bila', 'Diza', 'Kiki'],
    'Usia': [20, 25, 30, 17, 35],
...
if uploaded_file is not None:
    try:
        ...
        st.error("Gagal membaca file CSV: {e}")
else:
    st.info("Silakan unggah file untuk melihat datanya.")

# =========================
# Menampilkan DataFrame Acak (FIXED)
# =========================
random_df = pd.DataFrame(
    np.random.randn(10, 5), columns=["col {i}" for _ in range(5)]
)
